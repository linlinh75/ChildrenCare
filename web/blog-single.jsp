                                    ...
                                    <nav class="navigation">
                                        <ul class="nav menu">
                                            <li class="active"><a href="#">Home <i class="icofont-rounded-down"></i></a>
                                                <ul class="dropdown">
                                                    <li><a href="HomePage.html">Home Page 1</a></li>
                                                </ul>
                                            </li>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="single-main">
                                    ...
                                    <div class="meta">
                                        <div class="meta-left">
                                            <span class="author"><a href="#"><img src="img/author1.jpg" alt="#">${post.authorId}</a></span>
                            ...
                            <div class="single-widget recent-post">
                                ...
                                <c:forEach var="recentPost" items="${recentPosts}">
                                    ...
                                    <div class="single-post">
                                        <div class="image">
                                            <img src="${not empty recentPost.thumbnailLink ? recentPost.thumbnailLink : 'https://picsum.photos/seed/picsum/200/300'}" alt="${recentPost.title}">
                                        </div>
                                        <div class="content">
