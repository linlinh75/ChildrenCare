                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <c:if test="${not empty listUser}">
                                            <div class="alert alert-info">
                                                Debug: Found ${listUser.size()} users
                                            </div>
                                        </c:if>
                                        <c:choose>
                                ...
                                <div class="pagination-wrapper">
                                    <ul class="pagination">
                                        <c:if test="${currentPage > 1}">
                                            <li class="page-item">
                                                <a class="page-link" href="admin-manage-user?page=${currentPage - 1}
                        ${not empty searchKeyword ? '&search='+=searchKeyword : ''}
                        ${not empty genderFilter ? '&gender='+=genderFilter : ''}
                        ${not empty roleFilter ? '&role='+=roleFilter : ''}
                        ...
                        ${not empty sortOrder ? '&sortOrder='+=sortOrder : ''}">
                                        ...
                                        <c:forEach begin="1" end="${totalPages}" var="i">
                                            <li class="page-item ${currentPage == i ? 'active' : ''}">
                                                <a class="page-link" href="admin-manage-user?page=${i}
                        ${not empty searchKeyword ? '&search='+=searchKeyword : ''}
                        ${not empty genderFilter ? '&gender='+=genderFilter : ''}
                        ${not empty roleFilter ? '&role='+=roleFilter : ''}
                        ${not empty statusFilter ? '&status='+=statusFilter : ''}
