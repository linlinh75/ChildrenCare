...
<html lang="en">
  <head>
    ...
    <!-- simplebar -->
    <link
      href="${pageContext.request.contextPath}/assets/css/simplebar.css"
      rel="stylesheet"
      type="text/css"
    />
    <!-- Icons -->
    <link
      href="${pageContext.request.contextPath}/assets/css/materialdesignicons.min.css"
      rel="stylesheet"
      type="text/css"
    />
    <link
      href="${pageContext.request.contextPath}/assets/css/remixicon.css"
      rel="stylesheet"
      type="text/css"
    />
    <link
...
>>>>>>> d5243fade1882441e9df102265120ab1e1b09549

      <!-- Start Page Content -->
      <main class="page-content bg-light">
        <div class="container-fluid">
          <jsp:include
            page="../common/common-homepage-header.jsp"
          ></jsp:include>
...
<<<<<<< HEAD
          <div class="layout-specing">
            ...
            <div class="d-md-flex justify-content-between">
              <a
                id="close-sidebar"
                class="btn btn-icon btn-pills btn-soft-primary ms-2"
                href="#"
              >
                    ...
                    >
                      ...
                      <div class="row align-items-center mt-4">
                        <div class="col-lg-2 col-md-4">
                          <img
                            src="${pageContext.request.contextPath}${account.imageLink}"
                        ...
                        <div
                          class="col-lg-5 col-md-12 text-lg-right text-center mt-4 mt-lg-0"
                        >
                          <a href="#" class="btn btn-primary" id="uploadButton"
                            >Upload</a
                          >
...
${user.address}</textarea
          ...
          <jsp:include
            page="../common/common-homepage-footer.jsp"
          ></jsp:include>
        </div>
        <!--end container-->
      </main>
