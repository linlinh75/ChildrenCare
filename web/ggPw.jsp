              ...
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <div data-mdb-input-init class="form-outline mb-4">
                  ...
                  <div class="pt-1 mb-4 row">
                      <button data-mdb-button-init data-mdb-ripple-init class="btn btn-dark btn-lg btn-block" type="submit" name="submit" value="submit">Set Password</button>
                  </div>
                </form>
