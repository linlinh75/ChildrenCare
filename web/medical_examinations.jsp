  ...
  <body>
      ...
      <div class="d-flex justify-content-between mt-5">
        <div class="input-group w-50">
          ...
          <button
            ...
            type="button"
            onclick="searchExaminations()"
          >
            Search
          </button>
        </div>
        <div>
          <a href="staff-exam?action=add" class="btn btn-primary"
            >Add Examination</a
          >
        </div>
      </div>
          ...
          <tbody>
            <c:forEach var="exam" items="${examinations}">
              <tr class="exam-row">
                ...
                <td>
                  <a
                    href="staff-exam?action=edit&id=${exam.id}"
      ...
      $(document).ready(function () {
        ...
        function updatePagination() {
          ...
          if (pageCount > 1) {
            ...
            // Add Next button
            pagination.append(
              '<li class="page-item" id="next-page"><span class="page-link">Next</span></li>'
            );
          }
    ...
    <script>
      function confirmDelete(examId) {
        if (
          confirm("Are you sure you want to delete this medical examination?")
        ) {
