...
INSERT INTO `feedback` VALUES (113,1,5,'Great service!',4,'image1.jpg','Processing',NULL,'2024-10-21 20:54:06'),(114,2,4,'Good experience.',4,'image2.jpg','Processed',NULL,'2024-10-21 20:54:06'),(115,3,3,'Average service.',3,'image3.jpg','Processing',NULL,'2024-10-21 20:54:06'),(116,4,2,'Needs improvement.',2,'image4.jpg','Processed',NULL,'2024-10-21 20:54:06');
...
CREATE TABLE `post_comment` (
  ...
  KEY `post_post_comment_idx` (`post_id`),
  KEY `user_post_comment_idx` (`user_id`),
  CONSTRAINT `post_post_comment` FOREIGN KEY (`post_id`) REFERENCES `post` (`id`),
  CONSTRAINT `user_post_comment` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
...
INSERT INTO `post_comment` VALUES (1,46,NULL,'Bài viết rất hay và bổ ích!',1,'2024-10-14 10:00:00'),(2,47,NULL,'Tôi hoàn toàn đồng ý với quan điểm này.',2,'2024-10-14 10:15:00'),(3,48,NULL,'Có thể giải thích rõ hơn về điểm này không?',3,'2024-10-14 10:30:00'),(4,49,NULL,'Thông tin này rất hữu ích cho dự án của tôi.',4,'2024-10-14 10:45:00'),(5,50,NULL,'Tôi có một số ý kiến khác về vấn đề này.',5,'2024-10-14 11:00:00'),(6,46,1,'Cảm ơn bạn đã chia sẻ!',2,'2024-10-14 11:15:00'),(7,47,2,'Bạn có thể chia sẻ thêm ý kiến của mình không?',3,'2024-10-14 11:30:00'),(8,48,3,'Tôi sẽ cố gắng giải thích rõ hơn trong bài viết tiếp theo.',1,'2024-10-14 11:45:00'),(9,49,4,'Rất vui khi bài viết hữu ích cho bạn!',5,'2024-10-14 12:00:00'),(10,50,5,'Hãy chia sẻ ý kiến của bạn, tôi rất muốn lắng nghe.',4,'2024-10-14 12:15:00');
...
INSERT INTO `reservation` VALUES (102,1,'2021-07-25','Success',4,'2021-07-29 00:00:00'),(103,1,'2021-07-30','Cancel',4,'2021-07-29 00:00:00'),(104,2,'2021-07-16','Submitted',4,'2021-07-29 00:00:00'),(105,2,'2021-07-17','Approved',4,'2021-07-30 00:00:00'),(106,3,'2021-07-22','Approved',4,'2021-07-28 00:00:00'),(107,4,'2021-07-29','Cancel',4,'2021-07-29 00:00:00'),(108,3,'2021-07-02','Submitted',4,'2021-07-28 00:00:00'),(109,1,'2021-07-04','Submitted',4,'2021-07-27 00:00:00'),(110,4,'2021-07-08','Approved',4,'2021-07-28 00:00:00'),(111,2,'2021-07-08','Approved',4,'2021-07-28 00:00:00'),(112,5,'2021-07-20','Approved',4,'2021-07-28 00:00:00'),(113,3,'2021-07-29','Submitted',4,'2021-07-27 00:00:00');
...
-- Dump completed on 2024-10-21 21:01:47
